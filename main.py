...
app = webapp2.WSGIApplication([
    ...
    ('/answer',AnswerHandler),('/share',ShareHandler),('/showsharedposts',ShowsharedPosts),('/showsellposts',ShowsellPosts),('/friendpic',FriendPic),('/notify',NotifyHandler),('/showfriends',ShowFriends),('/showproducts',showProducts),
], debug=True)
